...
import fuego from '../../assets/enemies/fuego.png'
import '../../styles/Game.css'
import Bar from '../Bar'
import { GameContext } from "../../context/GameContext"
import { toast } from 'react-toastify'

const FireSlime = ({ id, combatEvent, setAttakedPlayer, setDanioJugador }) => {
  ...
  // 👉 estado lógico
  const [hp, setHp] = useState(12 + (2*data.level))
  ...
  useEffect(()=>{
    ...
    if(data.turn % 2 === 1){
      ...
      if(intent === "❓"){
        ...
        toast.warning(`El enemigo aumentó su ataque!`,{theme:'dark'})
        setData(prev => ({ ...prev, turn: prev.turn + 1 }))
      }
    }
  ...
  return(
    <div className="enemy" title={desc} onAnimationEnd={()=>setPegando(false)}>
      ...
      <img src={fuego} alt="" className={pegando ? "pegarEnemigo" : ""} />
